...
import "./Header.css";
import banner from "../../assets/img/illustration.png";
function Header() {
  return (
    <React.Fragment>
      <div className="header">
        <div className="logo">
          ...
          <p className="logoText"> | Developers</p>
        </div>
        <div className="Nav">
          <ul className="items">
            <li>
      ...
      <div className="banner">
        <div className="banner_left_quote">
          <h1>
            <span>Let's build the future of design, now.</span>
          </h1>
          <p className="small_description">
            Create amazing tools and intergration for 1 million users or
            customise Marvel for your team.
          </p>
          <div>
          <ul className="banner_buttons">
            <li>View the docs</li>
